...
// Estado de la IA de voz (Groq/Gemini). Cada consulta pingea los modelos, así que
// no la refrescamos sola: solo al entrar a la página o al tocar "Actualizar".
export function useEstadoIA() {
  return useQuery({
    queryKey: ['ia-estado'],
    queryFn: () => req('/api/ia/estado'),
    retry: false,
    staleTime: 60_000,
